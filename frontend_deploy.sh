...
# Energy Monitor Frontend Deployment Script
# This script pulls latest code, rebuilds frontend, and redeploys containers
...
# Print header
echo "=========================================="
echo "  Energy Monitor Frontend Deployment"
echo "=========================================="
echo ""
...
print_status "Step 2: Verifying frontend structure..."
...
# Step 5: Rebuild Docker containers (to pick up new frontend assets)
print_status "Step 5: Rebuilding Docker containers with new frontend assets..."
